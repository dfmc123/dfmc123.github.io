  ...
  <div class="about">
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item hello">
        ...
        <span class="text2 title2">我是 Blackcat</span>
        <span class="text3">是一名 励志玩遍所有魂游的魂5</span>
      </div>
      <!-- 追求 -->
      <div class="about-item pursuit">
        <span class="tip">对魂的追求</span>
        <span class="title2">源于</span>
        <span class="title2">热爱而去体验和感受</span>
    ...
    <div class="about-content" style="grid-template-columns: 2fr 3fr">
      ...
      <div class="about-item career">
        ...
        <div class="list">
          <span class="list-item" style="--color: #357ef5">艾尔登法环</span>
          <span class="list-item" style="--color: #eb372a">黑暗之魂3</span>
          <span class="list-item" style="--color: #e8372a">黑夜君临</span>
          <span class="list-item" style="--color: #eb472a">只狼</span>
          <span class="list-item" style="--color: #eb372a">黑暗之魂1</span>
        </div>
        <img
          class="career-img"
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item">
        ...
        <span class="title1" style="margin-top: 20px">指母加戳，</span>
        <span class="title2">强的是我。</span>
      </div>
    </div>
      ...
      <div class="about-item child">
        ...
        <div class="about-item info">
          <div class="info-item">
            ...
            <span class="info-num" style="--color: #43a6c6">2008</span>
          </div>
          <div class="info-item">
            <span class="info-name">生日</span>
            <span class="info-num" style="--color: #dfac46">11月14日</span>
          </div>
        </div>
      </div>
    </div>
