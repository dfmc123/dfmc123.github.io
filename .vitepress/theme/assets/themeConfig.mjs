...
export const themeConfig = {
  ...
  footer: {
    ...
    social: [
      {
        icon: "email",
        link: "mailto:mcdfnb@163.com",
      },
      {
        icon: "github",
        link: "https://www.github.com/dfmc123/",
      },
      {
        icon: "telegram",
        link: "//",
    ...
    sitemap: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "一个导航", link: "/", newTab: true },
          { text: "站点订阅", link: "/", newTab: true },
          {
            text: "反馈投诉",
